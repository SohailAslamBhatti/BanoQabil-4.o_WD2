...
arrTotal = arr3.reduce((accumulator, current) => accumulator + current, 0)
...
// Assignment #31 : From this array return a new array of only usernames.
const users = [
...
// Assignment #35 : From a list of employees, return a new array that adds a new field: "status": "active" to each object.
const employees = [
  { name: "Ali", id: 1 },
  { name: "Zara", id: 2 },
  { name: "Umar", id: 3 }
